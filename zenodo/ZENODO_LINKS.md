...
- **Format**: Fortran source (.for) + Octave/Matlab wrappers (.m)
- **License**: Creative Commons Attribution 4.0 International

### Documentation
- **Location**: `/markdown` directory
- **Format**: Markdown files with extensive mathematical documentation

### Original Publications
Katz JO, Rohlf FJ. Functionplane–A New Approach to Simple Structure Rotation. Psychometrika. 1974;39(1):37-51.
[https://doi.org/10.1007/BF02291576]
...
- **ORCID Profile**: [https://orcid.org/0009-0001-2777-6306]
- **Author Website**: [www.scientific-consultants.com]
